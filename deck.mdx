...
<Head>
  ...
  <meta name='twitter:description' content='— The modern web framework for building blazing fast websites and apps.' />
</Head>
...
<div style={{ textAlign: 'left', maxWidth: 1200, margin: '0 auto' }}>
  ...
  <h2>— The modern web framework for building blazing fast websites and apps.</h2>
...
<ul style={{ textAlign: 'left' }}>
  <Appear>
    <li>I'm Ismail Ghallou also known on the web as Smakosh.</li>
...
As a web developer, who wants to make a website or a web app, you're surrounded by so many choices, resources & communities.
...
Hopefully you bet on JavaScript as I did 😅, if so, you will have to narrow the choices down a bit and because you want to build a website/web app & not an API or any server side thing.
...
- A SSG like Jekyll, Hugo and Pelican?
...
#### Gatsby is a modern framework to build progressive web apps
...
### But what’s so awesome about it?
...
<Flex>
  ...
  <Item width="50">
    <img src="https://i.imgur.com/aDRKKk2.png" alt="chart" />
  </Item>
</Flex>
...
- https://smakosh.com
- https://github.com/smakosh/ZEIT-community-meetup-gatsby-talk-slides
- https://Gatsbyjs.org
